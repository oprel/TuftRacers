...
namespace Supyrb.EditorTools
{
    ...
    public class ApplySelectedPrefabs
    {
        ...
        [MenuItem("Tools/Apply Changes To Selected Prefabs %j", false, 100)]
        private static void ApplyPrefabs()
        {
            SearchPrefabConnections(ApplyToSelectedPrefabs);
        }
 
        [MenuItem("Tools/Revert Changes Of Selected Prefabs", false, 100)]
        private static void ResetPrefabs()
        {
            SearchPrefabConnections(RevertToSelectedPrefabs);
        }
 
        [MenuItem("Tools/Apply Changes To Selected Prefabs", true)]
        [MenuItem("Tools/Revert Changes Of Selected Prefabs", true)]
