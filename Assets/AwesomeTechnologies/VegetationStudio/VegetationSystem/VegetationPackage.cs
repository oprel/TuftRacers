...
namespace AwesomeTechnologies
{
    ...
    public class VegetationItemInfo
    {
        ...
        public VegetationShaderType ShaderType = VegetationShaderType.Standard;
    ...
    public class VegetationPackage : ScriptableObject
    {
        ...
        /// <param name="vegetationItemID"></param>
        /// <returns></returns>
        public string AddVegetationItem(Texture2D texture, VegetationType vegetationType, bool enableRuntimeSpawn, string vegetationItemID = "")
        {
            if (vegetationItemID == "") vegetationItemID = Guid.NewGuid().ToString();
            GameObject defaultTexturePrefab = Resources.Load("DefaultGrassPatch") as GameObject;
        ...
        public void SetupTerrainTextureSettings()
        {
            ...
            if (TerrainTextureSettingsList.Count < TerrainTextureCount)
            {
                ...
                var defaultPackage = (VegetationPackage)Resources.Load("DefaultVegetationPackage", typeof(VegetationPackage));
                if (defaultPackage)
