...
namespace AwesomeTechnologies
{
    ...
    public class VegetationSystemEditor : VegetationStudioBaseEditor
    {
        ...
        {
            "All","Trees","Large Objects", "Objetcs", "Plants", "Grass"
        };
        ...
        void DrawAdvancedInspector()
        {
            ...
            GUILayout.BeginVertical("box");
            EditorGUILayout.LabelField("Multithreading", LabelStyle);
            _vegetationSystem.EnableUnlimitedVegetationItems = EditorGUILayout.Toggle("Enable unlimited items", _vegetationSystem.EnableUnlimitedVegetationItems);
            EditorGUILayout.HelpBox("Enabling this will allow for batched multi threading and more than 64 vegetation items. No speed change. Enable if you need additional items.", MessageType.Info);
            GUILayout.EndVertical();
        }
        ...
        {
            _vegetationSystem.ShowShadowsMenu = VegetationPackageEditorTools.DrawHeader("Shadows", _vegetationSystem.ShowShadowsMenu);
        ...
        {
            VegetationItemInfo vegetationItemInfo = _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex];
            if (vegetationItemInfo.ShaderType != VegetationShaderType.VegetationStudioGrass) return;

            _vegetationSystem.ShowVegetationItemGrassMenu = VegetationPackageEditorTools.DrawHeader("Vegetation Studio Grass", _vegetationSystem.ShowVegetationItemGrassMenu);
        ...
        void DrawRenderInspector()
        {
            ...
            _vegetationSystem.vegetationSettings.RenderAllShadows = EditorGUILayout.Toggle("Render all shadows",
                _vegetationSystem.vegetationSettings.RenderAllShadows);
            EditorGUILayout.HelpBox("When enabled all shadows within the shadow culling range will be rendered. This can help in some cases with low sun.", MessageType.Info);
            if (EditorGUI.EndChangeCheck())
            {
        ...
        void DrawVegetationInspector()
        {
            ...
            {
                //EditorGUILayout.LabelField("Add new vegetation item", LabelStyle);
                //EditorGUILayout.HelpBox("Drop a Texture2D or a Prefab with the vegetation item here to create new. Drop on selected category to get initial rules and settings correct.", MessageType.Info);
                //Color tempColor = GUI.backgroundColor;
                //GUI.backgroundColor = new Color(0.78f, 0.468f, 0.390f);
                //GameObject newGrassPrefab = EditorGUILayout.ObjectField("Add grass Prefab", null, typeof(GameObject), true) as GameObject;


                //GameObject newPlantPrefab = EditorGUILayout.ObjectField("Add plant Prefab", null, typeof(GameObject), true) as GameObject;
                //GameObject newTreePrefab = EditorGUILayout.ObjectField("Add tree Prefab", null, typeof(GameObject), true) as GameObject;
                //GameObject newObjectPrefab = EditorGUILayout.ObjectField("Add object Prefab", null, typeof(GameObject), true) as GameObject;
                //GameObject newLargeObjectPrefab = EditorGUILayout.ObjectField("Add large object Prefab", null, typeof(GameObject), true) as GameObject;


                //Texture2D newGrassTexture = EditorGUILayout.ObjectField("Add grass Texture2D", null, typeof(Texture2D), true) as Texture2D;
                //Texture2D newPlantTexture = EditorGUILayout.ObjectField("Add plant Texture2D", null, typeof(Texture2D), true) as Texture2D;
            ...
            EditorGUI.BeginChangeCheck();
            _selectedVegetationTypeIndex = GUILayout.SelectionGrid(_selectedVegetationTypeIndex, VegetationTypeNames, 3, EditorStyles.toolbarButton);
            if (EditorGUI.EndChangeCheck())
            {
            ...
            if (_vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList.Count == 0 ||
                _vegIndex >= _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList.Count || selectionCount == 0) return;
        ...
        void DrawExcludeTextures()
        {
            if (GUILayout.Button("Add new item"))
            {
                ...
                _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].ExcludeTextureMaskList.Add(newTextureMaskInfo);
                _excludeTextureMaskIndex = _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].ExcludeTextureMaskList.Count - 1;
            }

            GUIContent[] textureImageButtons = new GUIContent[_vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].ExcludeTextureMaskList.Count];

            for (int i = 0; i <= _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].ExcludeTextureMaskList.Count - 1; i++)
            {
                TextureMaskInfo tempMaskInfo = _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].ExcludeTextureMaskList[i];
                ...
                {
                    if (tempMaskInfo.TextureLayer >= _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].TerrainTextureCount)
                    {
            ...
            if (textureImageButtons.Length > 0)
            {
                ...
                if (GUILayout.Button("Delete selected item"))
                {
                    _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].ExcludeTextureMaskList.RemoveAt(_excludeTextureMaskIndex);
                    return;
                }

                TextureMaskInfo tempMaskInfo = _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].ExcludeTextureMaskList[_excludeTextureMaskIndex];
        ...
        void DrawIncludeTextures()
        {
            if (GUILayout.Button("Add new item"))
            {
                ...
                _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].IncludeTextureMaskList.Add(newTextureMaskInfo);
                _includeTextureMaskIndex = _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].IncludeTextureMaskList.Count - 1;
            }

            GUIContent[] textureImageButtons = new GUIContent[_vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].IncludeTextureMaskList.Count];

            for (int i = 0; i <= _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].IncludeTextureMaskList.Count - 1; i++)
            {
                TextureMaskInfo tempMaskInfo = _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].IncludeTextureMaskList[i];
            ...
            if (textureImageButtons.Length > 0)
            {
                ...
                if (GUILayout.Button("Delete selected item"))
                {
                    _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].IncludeTextureMaskList.RemoveAt(_includeTextureMaskIndex);
                    return;
                }

                TextureMaskInfo tempMaskInfo = _vegetationSystem.VegetationPackageList[_vegetationSystem.VegetationPackageIndex].VegetationInfoList[_vegIndex].IncludeTextureMaskList[_includeTextureMaskIndex];
        ...
        void DrawSettingsInspector()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                if (_vegetationSystem.AutoselectCamera) _vegetationSystem.SetCamera(null);
            }
            ...
            if (!_vegetationSystem.AutoselectCamera)
            {
                ...
                if (camera != _vegetationSystem.GetCamera()) _vegetationSystem.SetCamera(camera);
            }
