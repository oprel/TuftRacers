...
namespace AwesomeTechnologies.VegetationStudio
{
    ...
    public partial class VegetationStudioManager
    {
        ...
        protected void Instance_RegisterVegetationSystem(VegetationSystem vegetationSystem)
        {
        ...
        /// </summary>
        /// <param name="vegetationSystem"></param>
        protected void Instance_UnregisterVegetationSystem(VegetationSystem vegetationSystem)
        {
        ...
        public static void SetWaterLevel(float waterLevel)
        {
            ...
            if (Instance)
            {
                for (int i = 0; i <= Instance.VegetationSystemList.Count - 1; i++)
                {
                    Instance.VegetationSystemList[i].SetWaterLevel(waterLevel);
                }
            }
        }
        ...
        /// <summary>
        /// Sets a new VegetationPackage from index on all VegetationSystem components in the scene. The package must already be assigned to the VegetationSystem Component.
        /// </summary>
        /// <param name="index"></param>
        /// <param name="resetCullingGroup"></param>
        public static void SetVegetationPackage(int index, bool resetCullingGroup)
        {
            if (!Instance) FindInstance();
            ...
            if (Instance)
            {
                for (int i = 0; i <= Instance.VegetationSystemList.Count - 1; i++)
                {
                    ...
                    {
                        Instance.VegetationSystemList[i].SetVegetationPackage(index, resetCullingGroup);
                    }
                    else
                    {
                        Instance.VegetationSystemList[i].VegetationPackageIndex = index;
                    }
        ...
        public static void VegetationPackageSync_RefreshVegetationPackage(VegetationSystem sourceVegetationSystem)
        {
            ...
            if (Instance)
            {
                ...
                for (int i = 0; i <= Instance.VegetationSystemList.Count - 1; i++)
                {
                    if (Instance.VegetationSystemList[i] != sourceVegetationSystem)
                    {
        ...
        public static void VegetationPackageSync_RefreshVegetationPackage(VegetationPackage updatedVegetationPackage)
        {
            ...
            if (Instance)
            {
                for (int i = 0; i <= Instance.VegetationSystemList.Count - 1; i++)
                {
                    if (Instance.VegetationSystemList[i].CurrentVegetationPackage == updatedVegetationPackage)
                    {
                        Instance.VegetationSystemList[i].RefreshVegetationPackage(true);
                    }
                }
